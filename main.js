...
switch (QUIZE.quistion_1) {
    case "c) Adding static types to JavaScript":
        console.log(chalk.bold.italic.yellowBright("1Q : Your Answer Is Correct"));
        score += 10;
        break;
    default:
        console.log(chalk.bold.magentaBright("1Q : Your Answer Is Incorrect!"));
...
switch (QUIZE.quistion_2) {
    case "d) let number: number = 5;":
        ...
        break;
    default:
        console.log(chalk.bold.magentaBright("2Q : Your Answer Is Incorrect!"));
...
switch (QUIZE.quistion_3) {
    case "b) function add(a: number, b: number): number {}":
        ...
        break;
    default:
        console.log(chalk.bold.magentaBright("3Q : Your Answer Is Incorrect!"));
...
switch (QUIZE.quistion_4) {
    case "d) decimal":
        ...
        break;
    default:
        console.log(chalk.bold.magenta("4Q : Your Answer Is Incorrect"));
